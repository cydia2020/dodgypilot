...
git checkout --orphan $DEBUG_BRANCH
...
git add -f .
git commit --amend -m "openpilot debug v$VERSION"
...
if [ ! -z "$DEBUG_BRANCH" ]; then
  ...
  git push -f origin $DEBUG_BRANCH:$DEBUG_BRANCH
fi
