...
class CarController:
  ...
  def update(self, CC, CS):
    ...
    if self.CP.enableGasInterceptor and (CC.enabled and not CS.out.gasPressed) and self.CP.openpilotLongitudinalControl and self.CP.carFingerprint not in FULL_SPEED_DRCC_CAR:
