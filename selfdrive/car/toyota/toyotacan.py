...
def create_accel_command(packer, accel, pcm_cancel, standstill_req, lead, accel_stop_decision, permit_braking, acc_type, distance_button, fcw_alert, lead_vehicle_stopped, at_raw, msg='ACC_CONTROL'):
  ...
  values = {
    ...
    "ACCEL_CONT_DECISION": accel_stop_decision,
  }
